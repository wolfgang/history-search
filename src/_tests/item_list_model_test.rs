...
mod construction {
    ...
    fn has_no_filtered_items_after_construction() {
        let items = Vec::new();
        let model = ItemListModel::new(20, &items);
    ...
    fn if_not_enough_rows_adapt_selection_window_height() {
        let items = Vec::new();
        let model = ItemListModel::new(7, &items);
...
mod filtering {
    ...
    fn add_to_search_term_adds_character_to_search_term() {
        ...
        let mut model = ItemListModel::new(20, &items);
...
mod selection {
    ...
    fn change_selection_scrolls() {
        ...
        let mut model = ItemListModel::new(5, &items);
